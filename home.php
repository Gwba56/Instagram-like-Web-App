...
$page_max = $page->define_total_pages();
...
$pub = new Publication;
$rows = $pub->display_all_publications(); 
    ...
    <div class="col s12 m6 l4">
      <div class="card center-align">
        <div class="card-image">
          <a href="publication.php?pid=<?php echo $rows[$i]['picture_id'];?>"><img src="<?= $rows[$i]['path'] ?>"></a>
        </div>
      </div>
    </div>
    <?php } } ?>
...
<ul class="pagination center">
    <?php if($prev > 0) { ?>
    <li class="waves-effect"><a href="home.php?page=<?= $prev ?>"><i class="material-icons">chevron_left</i></a></li>
    <?php } ?>
    <li class="teal"><a href="#!"><?= $cur_page ?></a></li>
    <?php if($cur_page < $page_max) { ?>
    <li class="waves-effect"><a href="home.php?page=<?= $next ?>"><i class="material-icons">chevron_right</i></a></li>
    <?php } ?>
</ul>
<?php } else { ?>
