    ...
    <div class="row">
        <div class="col s10 m8 l6 offset-s1 offset-m2 offset-l3">
            <div class="card-panel center-align grey lighten-4">
                ...
                <br/>
                <form action="controller/user.php?login" method="POST">
                    <input type="text" name="username" placeholder="Identifiant" autofocus required/></br>
                    <input type="password" name="password" placeholder="Mot de passe" required/></br>
                    <br/>
                    <button class="btn-large teal accent-4">Connexion</button>
                </form>
                <br/>
                <p><a href="resetPsswd.php">Mot de passe oublié ?</a></p>
                <div class="">
                    <p>Vous n'avez pas de compte ? <a href="register.php">Inscrivez vous</a> ou <a href="home.php">Revenir à l'accueil</a></p>
                </div>
            </div>
        </div>
    </div>
